            ...
            <div className='midRight'>
              ...
              <div className='rightBottom'>
                <div className='bottomMain'>
                  <div className='mainBoxes'>
                    <div className='itemNameAndPrice'>
                      <div className='itemName'>Bombay Masala Grilled Cheese</div>
                      <div className='itemPrice'>159/-</div>
                    </div>
                    <div className='itemVegNonvegType'>
                      <div className='vegButton'>
                  ...
                  <div className='mainBoxes'>
                    <div className='itemNameAndPrice'>
                      <div className='itemName'>Chicken Seekh Kebab SANDWICH</div>
                  ...
                  <div className='mainBoxes'>
                    <div className='itemNameAndPrice'>
                      <div className='itemName'>Mumbai Vada Pav</div>
                  ...
                  <div className='mainBoxes'>
                    <div className='itemNameAndPrice'>
                      <div className='itemName'>Veg Seekh Kebab Sub</div>
                      <div className='itemPrice'>159/-</div>
                    </div>
                    <div className='itemVegNonvegType'>
                      <div className='vegButton'>
